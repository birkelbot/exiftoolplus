...
sub test_rewrite_video_time_zone {
  ...
  my $datetime_string = $exiftool->GetValue('QuickTime:CreateDate');
  print "datetime_string = $datetime_string\n";
  my $datetime = DateTime::Parse::parse_datetime($datetime_string);
...
test_rewrite_video_time_zone('C:/Users/mbirk/exiftoolplus/_test/TESTING/Test_Video_Samsung.mp4', '+1200');
